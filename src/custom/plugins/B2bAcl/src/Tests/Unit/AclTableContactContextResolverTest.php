...
class AclTableContactContextResolverTest extends \PHPUnit\Framework\TestCase
{
    public function test_creation_of_resolver(): void
    {
    ...
    public function test_extract_id_for_contact_entity(): void
    {
    ...
    public function test_extract_id_based_on_ownership_context(): void
    {
